...
class LaundryManipulationNode:
    def __init__(self):
        ...
        self.grasp_height_above_floor = rospy.get_param("~grasp_height_above_floor", 0.07)
    ...
    def pick_cloth(self, grasp_target):
        ...
        pre_grasp_x_offset = -(self.gripper_tip_offset + 0.22)
...
#         # 4. Move from Box A to Box B
#         self.move_from_box_a_to_box_b()
#         self.drive_forward_distance(0.00)
